...
const Main = () => {
  ...
  const MinMaxMain = () => {
    ...
    if(minimizeSideBar) document.getElementById("main").style.marginLeft = "250px";
    else document.getElementById("main").style.marginLeft = "85px";
  }

  return (
      <Router>
        <NavBar MinMaxMain={MinMaxMain} mini={minimizeSideBar}/>  
