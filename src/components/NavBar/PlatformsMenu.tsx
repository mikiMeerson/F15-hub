...
import RoundButtonStyle from '../BasicStyles/RoundButton.module.css';
...
const PlatformsMenu = ({ switchPlatform }: PlatformsProps) => (
  <nav className={PlatformsStyle.menu}>
    ...
    <label className={`${RoundButtonStyle.roundButton} ${PlatformsStyle.menuOpenButton}`} htmlFor="menu-open">
